...
const debug = require('debug')('loopback:storage:service');
...
function StorageService(options) {
  ...
  if (options.forbidExtnames) {
    this.forbidExtnames = options.forbidExtnames;
  }
...
StorageService.prototype.createContainer = function(options, cb) {
  ...
  if ('object' === typeof options && !(options instanceof storage.Container)) {
    ...
    const Container = factory.getProvider(this.provider).storage.Container;
...
StorageService.prototype.upload = function(container, req, res, options, cb) {
  ...
  if (this.forbidExtnames && !options.forbidExtnames) {
    options.forbidExtnames = this.forbidExtnames;
  }
